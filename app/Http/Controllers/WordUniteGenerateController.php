...
class WordUniteGenerateController extends Controller
{
    public function createRapportUnite($idUnite)
    {
    ...
    $unite=UniteDeRecherche::find($idUnite);

					$projets=Projet::where('unite_id',$idUnite)->get();
					...
					foreach ($projets as $projet) 
					{
        				...
        				$filename=$unite->nomUnite.now().'.docx';
